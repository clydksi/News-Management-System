...
<div class="data-table-wrap" style="border-radius:0;border:none;border-top:1px solid var(--border)">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="badge badge-gray">
                            <span style="width:5px;height:5px;border-radius:50%;background:var(--ink-faint);flex-shrink:0"></span>
                            Inactive
                        </span>
                        <?php endif; ?>
                    </td>
                ...
                <tr>
                    <td colspan="7">
                        <div class="empty-state">
                            ...
                            <div class="empty-sub">Add a user to get started.</div>
                            <button onclick="openModal('addUserModal')" class="btn btn-purple">
    ...
    <div class="pg-bar">
        ...
        <div class="pg-btns">
            <?php if ($page > 1): ?>
            <a href="?tab=users&page=<?= $page-1 ?>" class="pg-btn">
                <span class="material-icons-round">chevron_left</span>
            </a>
            <?php endif; ?>
            <?php for ($i = max(1,$page-2); $i <= min($totalPages,$page+2); $i++): ?>
            <a href="?tab=users&page=<?= $i ?>" class="pg-btn <?= $i===$page?'active':'' ?>"><?= $i ?></a>
            <?php endfor; ?>
